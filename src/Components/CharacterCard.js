...
const CharacterCard = ({ character }) => {
	...
	return (
		<Card bordered={false} title={character.name} style={{ backgroundColor: '#c3c3c3', width: '90%', height: '90%' }}>
			<div style={{ overflowWrap: 'break-word', borderColor: '#c3c3c3', backgroundColor: '#c3c3c3' }}>
